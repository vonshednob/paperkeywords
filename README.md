...
`paperkeywords` can be used to transform those hex numbers into words (using [PGP word list](https://en.wikipedia.org/wiki/PGP_word_list)) and back again for recovery.
